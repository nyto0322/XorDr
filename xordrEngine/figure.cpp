...
Figure::Figure(QImage * mFig, QImage * status, QPoint pos, double size, double start, double duration
...
QImage *Figure::getMainfig() const
{
    return m_mainfig;
}

QImage *Figure::getStatus() const
{
    return m_status;
}
